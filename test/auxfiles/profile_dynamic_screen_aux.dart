...
class BirthdayPicker extends StatelessWidget {
  ...
  final Future<DateTime?> Function(BuildContext, DateTime, DateTime, DateTime)? datePickerBuilder;
  ...
  Widget build(BuildContext context) {
    return InkWell(
      onTap: () async {
        final picker = datePickerBuilder ??
            (BuildContext ctx, DateTime initial, DateTime first, DateTime last) =>
                showDatePicker(
                  context: ctx,
                  initialDate: initial,
                  firstDate: first,
